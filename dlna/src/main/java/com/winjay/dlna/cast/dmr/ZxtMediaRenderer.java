...
public class ZxtMediaRenderer {
    private static final String TAG = "ZxtMediaRenderer";
...
//                getDisplayHandler().onStop(player);
        ...
        try {
            ...
            LogUtil.d(TAG,  "getType: " +  device.getType().toString());
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    LogUtil.e(TAG, "runLastChangePushThread ex", ex);
                }
            }
        }.start();
    }
    ...
    synchronized public void stopAllMediaPlayers() {
        for (ZxtMediaPlayer mediaPlayer : mediaPlayers.values()) {
            ...
            if (!state.equals(TransportState.NO_MEDIA_PRESENT) ||
                ...
                LogUtil.d(TAG, "Stopping player instance: " + mediaPlayer.getInstanceId());
//                mediaPlayer.stop();
            }
        }
    }
