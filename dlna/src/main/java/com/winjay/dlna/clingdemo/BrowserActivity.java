...
package com.winjay.dlna.clingdemo;
...
public class BrowserActivity extends ListActivity {
    ...
    protected class BrowseRegistryListener extends DefaultRegistryListener {
        ...
        public void remoteDeviceDiscoveryStarted(Registry registry, RemoteDevice device) {
            Log.d(TAG, "remoteDeviceDiscoveryStarted():device=" + device.getDisplayString());
            deviceAdded(device);
        }

        @Override
        public void remoteDeviceDiscoveryFailed(Registry registry, final RemoteDevice device, final Exception ex) {
            Log.d(TAG, "remoteDeviceDiscoveryFailed():device=" + device.getDisplayString());
        ...
        public void remoteDeviceAdded(Registry registry, RemoteDevice device) {
            Log.d(TAG, "remoteDeviceAdded():device=" + device.getDisplayString());
            deviceAdded(device);
        }

        @Override
        public void remoteDeviceRemoved(Registry registry, RemoteDevice device) {
            Log.d(TAG, "remoteDeviceRemoved():device=" + device.getDisplayString());
            deviceRemoved(device);
        }

        @Override
        public void localDeviceAdded(Registry registry, LocalDevice device) {
            Log.d(TAG, "localDeviceAdded():device=" + device.getDisplayString());
            deviceAdded(device);
        }

        @Override
        public void localDeviceRemoved(Registry registry, LocalDevice device) {
            Log.d(TAG, "localDeviceRemoved():device=" + device.getDisplayString());
            deviceRemoved(device);
        }
