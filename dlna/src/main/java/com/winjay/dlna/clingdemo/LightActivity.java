 ...
 */
// DOC:CLASS
public class LightActivity extends AppCompatActivity implements PropertyChangeListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, 2, 0, "Light On/Off").setIcon(android.R.drawable.ic_menu_info_details);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case 1:
                ...
                break;
            case 2:
                boolean state = getSwitchPowerService().getManager().getImplementation().getStatus();
                getSwitchPowerService().getManager().getImplementation().setTarget(!state);
                break;
        }
        return false;
    }
