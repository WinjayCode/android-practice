...
public class MyVerticalTextView extends TextView {
    ...
    public MyVerticalTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLineSpacingExtra = Math.max(0, mLineSpacingExtra);
    ...
    public MyVerticalTextView setLeftToRight(boolean leftToRight) {
        isLeftToRight = leftToRight;
        return this;
    }

    public MyVerticalTextView setLineSpacingExtra(float lineSpacingExtra) {
        this.mLineSpacingExtra = Utils.dp2px(mContext, lineSpacingExtra);
        return this;
    }

    public MyVerticalTextView setCharSpacingExtra(float charSpacingExtra) {
        this.mCharSpacingExtra = Utils.dp2px(mContext, charSpacingExtra);
        return this;
    }

    public MyVerticalTextView setUnderLineText(boolean underLineText) {
        isUnderLineText = underLineText;
        return this;
    }

    public MyVerticalTextView setUnderLineColor(int underLineColor) {
        this.mUnderLineColor = underLineColor;
        return this;
    }

    public MyVerticalTextView setUnderLineWidth(float underLineWidth) {
        this.mUnderLineWidth = underLineWidth;
        return this;
    }

    public MyVerticalTextView setUnderLineOffset(float underLineOffset) {
        this.mUnderLineOffset = Utils.dp2px(mContext, underLineOffset);
        return this;
    }

    public MyVerticalTextView setShowActionMenu(boolean showActionMenu) {
        isShowActionMenu = showActionMenu;
        return this;
    }

    public MyVerticalTextView setTextHighlightColor(int color) {
